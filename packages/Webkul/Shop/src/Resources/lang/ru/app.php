...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Авторское право 2010 - :current_year. Все права защищены.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Авторское право 2010 - :current_year. Все права защищены.',
                'locale'                 => 'Язык',
                'newsletter-text'        => 'Подпишитесь на рассылку!',
